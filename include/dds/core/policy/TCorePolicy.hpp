...
class TTimeBasedFilter : public dds::core::Value<D>
{
    ...
    explicit TTimeBasedFilter(
            const dds::core::Duration& the_min_separation);
...
class TPartition : public dds::core::Value<D>
{
    ...
    explicit TPartition(
            const dds::core::StringSeq& partitions);
...
class TOwnership : public dds::core::Value<D>
{
    ...
    explicit TOwnership(
            dds::core::policy::OwnershipKind::type the_kind);
...
class TDurability : public dds::core::Value<D>
{
    ...
    explicit TDurability(
            dds::core::policy::DurabilityKind::type the_kind);
...
class TPresentation : public dds::core::Value<D>
{
    ...
    TPresentation(
            dds::core::policy::PresentationAccessScopeKind::type the_access_scope,
    ...
    TPresentation& access_scope(
            dds::core::policy::PresentationAccessScopeKind::type as);
...
class TReliability : public dds::core::Value<D>
{
    ...
    TReliability(
            dds::core::policy::ReliabilityKind::type the_kind,
    ...
    static TReliability Reliable(
            const dds::core::Duration& d = dds::core::Duration::infinite());
...
class TDestinationOrder : public dds::core::Value<D>
{
    ...
    explicit TDestinationOrder(
            dds::core::policy::DestinationOrderKind::type the_kind);
...
class THistory : public dds::core::Value<D>
{
    ...
    THistory(
            dds::core::policy::HistoryKind::type the_kind,
            int32_t the_depth);
...
class TLiveliness : public dds::core::Value<D>
{
    ...
    TLiveliness(
            dds::core::policy::LivelinessKind::type the_kind,
...
class TTypeConsistencyEnforcement : public dds::core::Value<D>
{
    ...
    TTypeConsistencyEnforcement& kind(
            dds::core::policy::TypeConsistencyEnforcementKind::type value);
