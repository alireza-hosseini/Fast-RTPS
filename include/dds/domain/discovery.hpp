...
namespace domain {
     ...
     *
     * @param dp the <code>DomainParticipant</code> for which the remote entity will be ignored
     * @param handle the <code>InstanceHandle</code> of the remote entity that has to be ignored
     */
    void ignore(
     ...
     *
     * @param dp the <code>DomainParticipant</code> for which the remote entity will be ignored
     * @param begin the begin iterator for the <code>InstanceHandle</code> to ignore
     * @param end the end iterator for the <code>InstanceHandle</code> to ignore
     */
